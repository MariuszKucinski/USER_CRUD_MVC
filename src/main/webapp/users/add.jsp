...
<form  method="post" class="m-auto" style="max-width:600px">
    <h3 class="my-4">Add User</h3>
    <hr class="my-4" />
    <div class="form-group mb-3 row"><label for="name2" class="col-md-5 col-form-label">Name</label>
        <div class="col-md-7"><input type="text" class="form-control form-control-lg" id="name2" name="name" required></div>
    </div>
    <div class="form-group mb-3 row"><label for="email3" class="col-md-5 col-form-label">Email</label>
        <div class="col-md-7"><input type="email" class="form-control form-control-lg" id="email3" name="email" required><small class="form-text text-muted"> Please enter a valid email address</small></div>
    </div>
    ...
    <div class="form-group mb-3 row"><label class="col-md-5 col-form-label"></label>
        <div class="col-md-7"><button class="btn btn-primary btn-lg" type="submit">Create User!</button></div>
    </div>
</form>
